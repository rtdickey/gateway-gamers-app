...
const navigation = [
  { name: "Game Keep", href: "/GameKeep", current: true },
      ...
      <div className='mx-auto max-w-7xl px-2 sm:px-6 lg:px-8'>
        <div className='relative flex h-16 items-center justify-between'>
                ...
                {navigation.map(item => (
                  <NavLink to={item.href} key={item.name}>
                    <a
                      ...
                      className={`${item.current ? "bg-accent text-gray-800" : "text-gray-800 hover:bg-accent hover:text-gray-800"} rounded-md px-3 py-2 text-sm font-medium`}
                    >
                      {item.name}
                    </a>
                  </NavLink>
          ...
          <div className='absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0'>
            {/* <button
              type='button'
              className='relative rounded-full bg-accent p-1 text-gray-800 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800'
            >
